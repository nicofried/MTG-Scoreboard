...
{
    public partial class Player6 : IDisposable
    {
        ...
        private bool MustChangePassword => PasswordP6 == "1234" && !passwordHasBeenSet;
        ...
        {
            Form1.Instance.Player6Name = Playername6; // Update the password in Form1.
        ...
        private void Callback(object? state)
        {
            InvokeAsync(() =>
            {
                ...
                TreacheryImagePath = "images/Treachery/" + Form1.Instance.Treachery6ImagePath;
                TreacheryRuleText = Form1.Instance.TreacheryRule6Path;
                PasswordP6 = Form1.Instance.ReturnP6Password;
                if (PasswordP6 == "1234")
                {
