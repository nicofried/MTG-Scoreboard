...
{
    public partial class Player3 : IDisposable
    {
        ...
        private bool MustChangePassword => PasswordP3 == "1234" && !passwordHasBeenSet;
        ...
        {
            Form1.Instance.Player3Name = Playername3; // Update the password in Form1.
        ...
        private void Callback(object? state)
        {
            InvokeAsync(() =>
            {
                ...
                TreacheryImagePath = "images/Treachery/" + Form1.Instance.Treachery3ImagePath;
                TreacheryRuleText = Form1.Instance.TreacheryRule3Path;
                PasswordP3 = Form1.Instance.ReturnP3Password;
                if (PasswordP3 == "1234")
                {
