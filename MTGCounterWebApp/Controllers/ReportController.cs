...
namespace MTGCounter.Controllers
{
    public partial class ReportController : Controller
    {
        ...
        public ReportController(IWebSocketMessageSender webSocketMessageSender)
        {
        ...
        [HttpPost("trigger-websocket-message")]
        public async Task<IActionResult> TriggerWebSocketMessage([FromBody] string message)
        {
            // Your logic to trigger a WebSocket message
            await _webSocketMessageSender.SendMessageAsync(message);
            return Ok();
        }

        // This is a placeholder for your actual WebSocket message sending logic
